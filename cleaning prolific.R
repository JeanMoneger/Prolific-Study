...
DataWide$Genre<-recode(DataWide$Genre, 
                       ...
                       o = "OTHER",
                       O= "OTHER",
                       Other="OTHER",  .default = levels(Set$Genre))

write.csv(DataWide, "Data Prolific Study.csv")




Set<-Data.Prolific.Study.csv
library(MASS)
library(reghelper)
str(Set)
...
summary(lm(log(EscapeRT)~Cond*GuiltP+NeutralRT+Age, data=SetMad))
summary(lm(log(FailureRT)~Cond*GuiltP+NeutralRT+Age, data=SetMadF))
summary(lm(log(SuccessRT)~Cond*GuiltP+NeutralRT+Age, data=SetMadS))

summary(lm(log(EscapeRT)~Cond*ShameP+NeutralRT+Age, data=SetMad))
summary(lm(log(FailureRT)~Cond*ShameP+NeutralRT+Age, data=SetMadF))
summary(lm(log(SuccessRT)~Cond*ShameP+NeutralRT+Age, data=SetMadS))

summary(lm(log(EscapeRT)~Cond*Vnarc+NeutralRT+Age, data=SetMad))
summary(lm(log(FailureRT)~Cond*Vnarc+NeutralRT+Age, data=SetMadF))
summary(lm(log(SuccessRT)~Cond*Vnarc+NeutralRT+Age, data=SetMadS))

summary(lm(log(EscapeRT)~Cond*Gnarc+NeutralRT+Age, data=SetMad))
summary(lm(log(FailureRT)~Cond*Gnarc+NeutralRT+Age, data=SetMadF))
summary(lm(log(SuccessRT)~Cond*Gnarc+NeutralRT+Age, data=SetMadS))

summary(lm(log(EscapeRT)~Cond*SelfComp+NeutralRT+Age, data=SetMad))
summary(lm(log(FailureRT)~Cond*SelfComp+NeutralRT+Age, data=SetMadF))
summary(lm(log(SuccessRT)~Cond*SelfComp+NeutralRT+Age, data=SetMadS))
